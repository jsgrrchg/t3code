...
export const FollowUpMessageBehavior = Schema.Literals(["queue", "steer"]);
...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Desktop-only presentation preference. Browser clients deliberately ignore
  // the value so one local choice cannot change another client surface.
  showChangedFilesInChat: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const ServerSettings = Schema.Struct({
  ...
  generatedWorktreeBranchPrefix: TrimmedString.pipe(
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  generatedWorktreeBranchPrefix: Schema.optionalKey(TrimmedString),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  showChangedFilesInChat: Schema.optionalKey(Schema.Boolean),
