...
import {
  ...
  type RunThreadProviderActionInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    runProviderAction: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:run-provider-action",
      execute: (input: RunThreadProviderActionInput) => runThreadProviderAction(input),
      scheduler,
      concurrency,
    }),
