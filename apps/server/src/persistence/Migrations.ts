...
import Migration0041 from "./Migrations/041_ProjectionThreadsActiveOrderKey.ts";
import Migration0042 from "./Migrations/042_ProjectionThreadsParentThreadId.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadsActiveOrderKey", Migration0041],
  [42, "ProjectionThreadsParentThreadId", Migration0042],
] as const;
