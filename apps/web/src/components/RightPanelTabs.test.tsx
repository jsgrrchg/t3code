...
function renderTabs(first: DesktopPreviewFavicon | null, second?: DesktopPreviewFavicon) {
  return renderToStaticMarkup(
    <RightPanelTabs
      ...
      onCloseOtherSurfaces={async () => true}
      onCloseSurfacesToRight={async () => true}
      onCloseAllSurfaces={async () => true}
      ...
      onDeleteChat={async () => true}
      liveAgentCount={0}
      browserAvailable
      terminalAvailable={false}
      diffAvailable={false}
      historyAvailable={false}
      historyDisabledReason="Unavailable"
      filesAvailable={false}
      chatAvailable={false}
      chatTitlesById={new Map()}
      panelChats={[]}
